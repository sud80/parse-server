...
DatabaseController.prototype.find = function (className, query) {
  ...
  var isMaster = acl === undefined;
  var aclGroup = acl || [];
  var isIdMatchQuery = query.objectId && (typeof query.objectId == 'string' || !_lodash2.default.some(query.objectId, function (value, key) {
    return !_lodash2.default.includes(['$in', '$eq'], key);
  }));
  var op = isIdMatchQuery ? 'get' : 'find';
      ...
      return (isMaster ? Promise.resolve() : schemaController.validatePermission(className, aclGroup, op)).then(function () {
        ...
        if (count) {
          ...
          if (!classExists) {
            ...
            return _this10.adapter.find(className, schema, query, { skip: skip, limit: limit, sort: sort, fields: fields, hint: hint }).then(function (objects) {
