...
var SchemaController = function () {
  ...
  _createClass(SchemaController, [{
    ...
    value: function reloadData() {
      ...
      this.reloadDataPromise = Promise.resolve().then(function () {
        if (options.clearCache) {
          return _this._cache.clear().then(function () {});
        }
        return _this._cache.getSchemaInfo();
      }).then(function (schemaInfo) {
        if (schemaInfo) {
          return schemaInfo;
        }
        return _this.getAllClasses(options).then(function (allSchemas) {
          var data = {};
          var perms = {};
          ...
          var schemaInfo = { data: Object.freeze(data), perms: Object.freeze(perms) };
          _this._cache.setSchemaInfo(schemaInfo);
          return schemaInfo;
        });
      }).then(function (schemaInfo) {
        _this.data = schemaInfo.data;
        _this.perms = schemaInfo.perms;
    ...
    value: function getAllClasses() {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this2._dbAdapter.getAllClasses().then(function (allSchemas) {
          ...
          return _this2._cache.setAllClasses(Object.freeze(allSchemas)).then(function () {
            return allSchemas;
          });
        });
      });
