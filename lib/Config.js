...
var Config = exports.Config = function () {
  function Config(applicationId, mount) {
    ...
    if (cacheInfo.reuseSchemaCache) {
      ...
      var schemaCache = new _SchemaCache2.default(cacheInfo.schemaCache.cache, cacheInfo.schemaCacheTTL);
    ...
    this.supportOriginalObject = cacheInfo.supportOriginalObject;
  }
