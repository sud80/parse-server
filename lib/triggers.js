...
function getRequestObject(triggerType, auth, parseObject, originalParseObject, config, state) {
  var request = {
...
function maybeRunTrigger(triggerType, auth, parseObject, originalParseObject, config, state) {
  if (!parseObject) {
