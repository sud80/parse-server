...
var MongoCollection = function () {
  ...
  _createClass(MongoCollection, [{
    ...
    value: function find(query) {
      ...
      return this._rawFind(query, { skip: skip, limit: limit, sort: sort, fields: fields }).catch(function (error) {
        ...
        // Retry, but just once.
        .then(function () {
          return _this._rawFind(query, { skip: skip, limit: limit, sort: sort, fields: fields });
        });
      });
    }
  }, {
    ...
    value: function _rawFind(query) {
      ...
      return this._mongoCollection.find(query, { skip: skip, limit: limit, sort: sort, fields: fields }).toArray();
    }
  }, {
    key: 'count',
