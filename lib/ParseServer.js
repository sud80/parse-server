...
var _InMemoryObjectCacheAdapter = require('./Adapters/Cache/InMemoryObjectCacheAdapter');
...
var ParseServer = function () {
  function ParseServer(_ref) {
    ...
    var schemaCache = _ref.schemaCache;
    ...
    var _ref$logTriggerSucces = _ref.logTriggerSuccess;
    var logTriggerSuccess = _ref$logTriggerSucces === undefined ? _defaults2.default.logTriggerSuccess : _ref$logTriggerSucces;
    var _ref$reuseSchemaCache = _ref.reuseSchemaCache;
    var reuseSchemaCache = _ref$reuseSchemaCache === undefined ? _defaults2.default.reuseSchemaCache : _ref$reuseSchemaCache;
    var _ref$supportOriginalO = _ref.supportOriginalObject;
    var supportOriginalObject = _ref$supportOriginalO === undefined ? _defaults2.default.supportOriginalObject : _ref$supportOriginalO;
    ...
    if (!schemaCache || !reuseSchemaCache) {
      var schemaCacheControllerAdapter = (0, _AdapterLoader.loadAdapter)(null, _InMemoryObjectCacheAdapter.InMemoryObjectCacheAdapter, {
        appId: appId,
        ttl: schemaCacheTTL
      });
      schemaCache = new _SchemaCache2.default(schemaCacheControllerAdapter, schemaCacheTTL);
    }
    ...
    var liveQueryController = void 0;
    if (liveQuery) {
      liveQueryController = new _LiveQueryController.LiveQueryController(liveQuery);
    }
    ...
    _cache2.default.put(appId, {
      ...
      logTriggerSuccess: logTriggerSuccess,
      reuseSchemaCache: reuseSchemaCache,
      supportOriginalObject: supportOriginalObject
    });
