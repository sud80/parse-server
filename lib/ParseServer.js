...
var ParseServer = function () {
  function ParseServer(_ref) {
    ...
    var schemaCacheControllerAdapter = (0, _AdapterLoader.loadAdapter)(null, _InMemoryObjectCacheAdapter.InMemoryObjectCacheAdapter, { appId: appId, ttl: schemaCacheTTL });
    var schemaCacheController = new _CacheController.CacheController(schemaCacheControllerAdapter, appId);
    ...
    var databaseController = new _DatabaseController2.default(databaseAdapter, new _SchemaCache2.default(schemaCacheController, schemaCacheTTL));
